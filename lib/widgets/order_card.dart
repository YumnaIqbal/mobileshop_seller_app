...
import 'package:mobileshop_seller_app/mainScreens/order_details_screen.dart';
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: ListView.builder(
          ...
          {
            Models model = Models.fromJson(data![index].data()! as Map<String, dynamic>);
...
Widget placedOrderDesignWidget(Models model, BuildContext context, seperateQuantitiesList)
{
  return Container(
